...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/swift-transformers.md)

[Pedro Cuenca](https://huggingface.co/pcuenq)

[pcuenq](https://huggingface.co/pcuenq)

[Christopher Fleetwood](https://huggingface.co/FL33TW00D-HF)

[FL33TW00D-HF](https://huggingface.co/FL33TW00D-HF)

[Mattt](https://huggingface.co/mattt)
...
![Test app from mlx-swift-examples, showing SmolVLM2 explaining actions in a video.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/swift-transformers/mlx-vlm-examples-birds.jpg)
...
[![](https://huggingface.co/blog/assets/dots-ocr-ne/dots_header.png)](https://huggingface.co/blog/dots-ocr-ne)

[coreml apple](https://huggingface.co/blog/dots-ocr-ne)
...
[View original](https://huggingface.co/blog/dots-ocr-ne)

[![](https://huggingface.co/blog/assets/mistral-coreml/thumbnail.png)](https://huggingface.co/blog/mistral-coreml)

[coreml guide llm](https://huggingface.co/blog/mistral-coreml)

WWDC 24: Running Mistral 7B with Core ML

- ![](https://cdn-avatars.huggingface.co/v1/production/uploads/6032802e1f993496bc14d9e3/w6hr-DEQot4VVkoyRIBiy.png)

pcuenq, FL33TW00D-HF, et. al.

64

July 22, 2024

[View original](https://huggingface.co/blog/mistral-coreml)

### Community

[JohnMai](https://huggingface.co/JohnMai)
...
It's a pleasure to work together [@ JohnMai](https://huggingface.co/JohnMai)!
