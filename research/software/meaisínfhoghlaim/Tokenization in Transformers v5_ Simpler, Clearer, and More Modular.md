...
source: "https://huggingface.co/blog/tokenizers#v5-separates-tokenizer-architecture-from-trained-vocab"
author:
published:
created: 2025-12-19
...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/tokenizers.md)

![Ita Zaporozhets's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/658f3fc8c0b1372b2e991992/SZspcJ3Z5S-W5vayJo-vJ.jpeg)

Ita Zaporozhets's avatar

[Ita Zaporozhets](https://huggingface.co/itazap)

[itazap](https://huggingface.co/itazap)

[Aritra Roy Gosthipaty](https://huggingface.co/ariG23498)

[ariG23498](https://huggingface.co/ariG23498)

[Arthur Zucker](https://huggingface.co/ArthurZ)

[ArthurZ](https://huggingface.co/ArthurZ)

[Sergio Paniego](https://huggingface.co/sergiopaniego)
...
[![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/thumbnail.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/thumbnail.png)
...
- [What is Tokenization?](https://huggingface.co/blog/#what-is-tokenization)
- [The Tokenization Pipeline](https://huggingface.co/blog/#the-tokenization-pipeline)
- [Tokenization Algorithms](https://huggingface.co/blog/#tokenization-algorithms)
- [Accessing `tokenizers` through `transformers`](https://huggingface.co/blog/#accessing-tokenizers-through-transformers)
- [The Tokenizer Class Hierarchy in `transformers`](https://huggingface.co/blog/#the-tokenizer-class-hierarchy-in-transformers)
- [`AutoTokenizer` Automatically Selects the Correct Tokenizer Class](https://huggingface.co/blog/#autotokenizer-automatically-selects-the-correct-tokenizer-class)
- [v5 Separates Tokenizer Architecture from Trained Vocab](https://huggingface.co/blog/#v5-separates-tokenizer-architecture-from-trained-vocab)
- [Summary](https://huggingface.co/blog/#summary)

> For experts: If you're already familiar with the concepts and want to understand the changes in v5, go to [v5 Separates Tokenizer Architecture from Trained Vocab](https://huggingface.co/blog/#v5-separates-tokenizer-architecture-from-trained-vocab)
...
> You can access the rust based tokenizer through `_tokenizer`. We go in more depth about it in [this section](https://huggingface.co/blog/#tokenizersbackend-wraps-the-tokenizers-library)
...
1. **Unigram** takes a probabilistic approach, selecting the most likely segmentation from a large initial vocabulary. This is more flexible than the strict BPE. (Read more about [Unigram](https://huggingface.co/learn/llm-course/en/chapter6/7))
...
1. **WordPiece** resembles BPE but uses different merge criteria based on likelihood. (Read more about [WordPiece](https://huggingface.co/learn/llm-course/en/chapter6/6))
...
| [![class hierarchy](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/hierarchy.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/hierarchy.png) |
| --- |
...
1. **Instantiate the correct class.**`AutoTokenizer` imports the appropriate tokenizer class and calls its `from_pretrained` method.
2. **Return the configured tokenizer.** You receive a fully configured, model-specific tokenizer ready for use.
...
| [![v4 llama](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/v4-llama.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/v4-llama.png) |
| --- |
...
| [![v5 llama](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/v5-llama.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/tokenizers/v5-llama.png) |
| --- |
...
[![](https://huggingface.co/blog/assets/transformers_v5/transformers-thumbnail.png)](https://huggingface.co/blog/transformers-v5)

[![](https://huggingface.co/blog/assets/hf-skills-training/thumbnail-codex.png)](https://huggingface.co/blog/hf-skills-training-codex)

[llm fine-tuning open-source](https://huggingface.co/blog/hf-skills-training-codex)
...
[View original](https://huggingface.co/blog/hf-skills-training-codex)