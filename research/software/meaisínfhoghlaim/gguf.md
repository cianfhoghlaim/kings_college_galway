...
Add the `gguf_file` parameter to [from_pretrained()](/docs/transformers/v5.0.0rc0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) to specify the GGUF file to load.
