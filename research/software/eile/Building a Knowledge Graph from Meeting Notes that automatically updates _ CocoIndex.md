---
title: "Building a Knowledge Graph from Meeting Notes that automatically updates | CocoIndex"
source: "https://cocoindex.io/blogs/meeting-notes-graph"
author:
  - "[[Linghua Jin]]"
published: 2025-12-08
created: 2025-12-11
description: "Building a Knowledge Graph from Meeting Notes that automatically updates"
tags:
  - "clippings"
---
![Building a Knowledge Graph from Meeting Notes that automatically updates](https://cocoindex.io/blogs/assets/images/cover-89c8acc0a7774e0214dad248b28c6d07.png)
...
The source code open sourced and available at [Meeting Notes Graph Code](https://github.com/cocoindex-io/cocoindex/tree/main/examples/meeting_notes_graph).

![Neo4j Property Graph](https://cocoindex.io/blogs/assets/images/neo4j-959fd6133a5d56588498bb8379afea90.png)
...
In large enterprises, the stakes around document processing become dramatically higher. The reality of meeting note management is far messier than "write once, read many":
...
- **Information scattered across systems** - Organizations often use multiple document repositories to store information, and the majority of business documents reside in email inboxes. This fragmentation makes it extremely challenging to build a comprehensive knowledge graph without intelligent, incremental processing.
...
![Overview](https://cocoindex.io/blogs/assets/images/flow-2d1d47d3bd28fed537306b1cf58803bb.png)
...
![Ingest documents](https://cocoindex.io/blogs/assets/images/ingest-8150bc90ba6c3b82d2877530fa1b28e7.png)
...
![Extract meetings](https://cocoindex.io/blogs/assets/images/meetings-91dc470d6ba1a7193b466b5a2a0677f7.png)
...
![Extract metadata](https://cocoindex.io/blogs/assets/images/metadata-135ce79a4e1a0b674de24657a2befd80.png)
...
We will be creating a property graph with following nodes and relationships:![Graph](https://cocoindex.io/blogs/assets/images/graph-250c2e403438bf2c9f3f45cbc58b6467.png)
...
| Fields of that row | Properties of the node (e.g. `note_file`, `time`, `note`) [CocoIndex](https://cocoindex.io/docs/targets?utm_source=chatgpt.com) |
...
- When you later export relationship collectors (e.g. ATTENDED, DECIDED, ASSIGNED\_TO), those relationships will reference nodes of type `Person` or `Task`. CocoIndex needs to know how to treat those node labels so it can create or match the corresponding nodes properly. `declare(...)` gives CocoIndex that knowledge.
...
![Map ATTENDED relationship](https://cocoindex.io/blogs/assets/images/export-173e15943a0c5aebdd72f347d8a9a0d9.png)
...
### Map ASSIGNED\_TO Relationship

**ASSIGNED\_TO relationships**
...
Then open the UI at [https://cocoindex.io/cocoinsight](https://cocoindex.io/cocoinsight).
