...
[shaun smith](https://huggingface.co/evalstate)

[evalstate](https://huggingface.co/evalstate)
...
1. For more details, see the [Codex AGENTS guide](https://developers.openai.com/codex/guides/agents-md).
...
[![](https://huggingface.co/blog/assets/anylanguagemodel/banner.png)](https://huggingface.co/blog/anylanguagemodel)

[llm coreml mlx](https://huggingface.co/blog/anylanguagemodel)
...
[View original](https://huggingface.co/blog/anylanguagemodel)

### Community

[ermiaazarkhalili](https://huggingface.co/ermiaazarkhalili)

Wow 😮  
You're awesome 😎

[dinoamino](https://huggingface.co/dinoamino)
...
[kylechristophermoore](https://huggingface.co/kylechristophermoore)

[yukiarimo](https://huggingface.co/yukiarimo)

Another agentic way of wasting tokens

[jzhang533](https://huggingface.co/jzhang533)

is it possible to use this inside vscode's copilot extension?

[aprotopopov](https://huggingface.co/aprotopopov)

•

[edited 1 day ago](https://huggingface.co/blog/#693320d1a96be1367dbb3b6d "Edited by aprotopopov")

Skill documentation is not available at the provided link - [https://github.com/huggingface/skills/blob/main/hf-llm-trainer/SKILL.md](https://github.com/huggingface/skills/blob/main/hf-llm-trainer/SKILL.md)
...
Ah, we moved a couple of bits around in the repo -- link for that is here: [https://github.com/huggingface/skills/blob/main/hf-llm-trainer/skills/model-trainer/SKILL.md](https://github.com/huggingface/skills/blob/main/hf-llm-trainer/skills/model-trainer/SKILL.md) -- I'll update the article 👍.

[AUsername111](https://huggingface.co/AUsername111)
