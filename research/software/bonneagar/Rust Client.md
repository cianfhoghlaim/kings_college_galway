---
title: "Rust Client"
source: "https://duckdb.org/docs/stable/clients/rust"
author:
  - "[[GitHub User]]"
published:
created: 2025-12-19
...
> The latest stable version of the DuckDB Rust client is 1.4.3.
...
The Rust client supports the [DuckDB Appender API](https://duckdb.org/docs/stable/data/appender.html) for bulk inserts. For example:
