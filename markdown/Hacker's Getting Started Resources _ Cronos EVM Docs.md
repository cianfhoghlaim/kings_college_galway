---
title: "Hacker's Getting Started Resources | Cronos EVM Docs"
source: "https://docs.cronos.org/for-dapp-developers/hacker-resources"
author:
...
[https://github.com/crypto-org-chain/cronos-docs/blob/gitbook/for-dapp-developers/broken-reference/README.md](https://github.com/crypto-org-chain/cronos-docs/blob/gitbook/for-dapp-developers/broken-reference/README.md)
...
- For more details, see [Metamask configuration](https://docs.cronos.org/for-users/metamask)
...
- [Build a Dapp: how to connect and interact with Web3 wallets on Cronos](https://docs.cronos.org/for-dapp-developers/chain-integration/web3-wallet)
...
- [Full list of available dev tools and integration](https://docs.cronos.org/for-dapp-developers/dev-tools-and-integrations/overview-of-dev-tools-and-integrations)
...
Feedback is a gift! [Let us know](https://docs.cronos.org/for-dapp-developers/) if there is anything that we can improve in this documentation.
