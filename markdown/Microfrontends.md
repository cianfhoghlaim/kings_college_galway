...
[Visit the Microfrontends section of your framework](https://turborepo.com/docs/guides/frameworks) for framework-specific guidance.
...
By default, the microfrontends proxy will try to use port 3024. If you already use that port for a different purpose, you can change Turborepo's port using the [`options.localProxyPort`](https://turborepo.com/docs/guides/#optionslocalproxyport).

### Missing CSS, images, or other assets, or routes not matching

Ensure that the paths that the microfrontends matches for in its [`routing` configuration](https://turborepo.com/docs/guides/#routing) include the routes for the assets. Check your network tab to find paths that are or aren't matching as expected.
...
- The `shop` app handles e-commerce functionality[Previous](https://turborepo.com/docs/guides/skipping-tasks)
...
](https://turborepo.com/docs/guides/migrating-from-nx)