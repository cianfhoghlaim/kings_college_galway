---
title: "GGUF"
source: "https://huggingface.co/docs/transformers/en/gguf"
author:
published:
created: 2025-12-17
...
Add the `gguf_file` parameter to [from\_pretrained()](https://huggingface.co/docs/transformers/v5.0.0rc1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) to specify the GGUF file to load.
...
[← FP-Quant](https://huggingface.co/docs/transformers/en/quantization/fp_quant) [GPTQ →](https://huggingface.co/docs/transformers/en/quantization/gptq)