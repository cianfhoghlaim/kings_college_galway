...
The example supports both EVM (Base, Ethereum) and Solana networks. The x402 client automatically selects the appropriate scheme based on the payment requirements:When the server returns a 402 response, the client checks the `network` field in the payment requirements:
...
- [Learn about building x402 servers](https://docs.cdp.coinbase.com/x402/quickstart-for-sellers)[Building Miniapps with x402](https://docs.cdp.coinbase.com/x402/miniapps)
