---
title: "Overview | TanStack AI Docs"
source: "https://tanstack.com/ai/latest/docs/getting-started/overview"
author:
  - "[[@tannerlinsley]]"
published:
created: 2025-12-05
description: "TanStack AI is a lightweight, type-safe SDK for building production-ready AI experiences. Its framework-agnostic core provides type-safe tool/function calling, streaming responses, and first-class Rea..."
tags:
  - "clippings"
---
...
- [Quick Start Guide](https://tanstack.com/ai/latest/docs/getting-started/quick-start) - Get up and running in minutes
- [Tools Guide](https://tanstack.com/ai/latest/docs/guides/tools) - Learn about the isomorphic tool system
- [API Reference](https://tanstack.com/ai/latest/docs/api/ai) - Explore the full API

[Edit on GitHub](https://github.com/tanstack/ai/edit/main/docs/getting-started/overview.md)
